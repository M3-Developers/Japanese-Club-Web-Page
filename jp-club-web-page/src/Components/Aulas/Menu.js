...
import documento from '../../Assets/PDF/nihongo-minicurso-ebook.pdf';
...
function Menu() {
    ...
    return(
        <div className='menu'>
            ...
            <Botao
                video = 'https://www.youtube.com/embed/dYWwhgrQS48?si=E3PX4d8X7xMwHk35" title="YouTube video player'
                title = 'Oque iremos estudar' 
                txt = 'Sobre o curso'
                descricao = '    A Constituição Federal de 1988 é a atual Carta Magna !'
                arquivo = {documento}
            />
